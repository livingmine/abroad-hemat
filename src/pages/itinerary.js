...
function ItineraryPage() {
  return (
    <Layout>
      ...
      <section>
        {/* <!-- Image cards --> */}
        <div className="flex flex-wrap xl:flex-no-wrap justify-center pt-12 align-middle mt-8 bg-black">
          <div className="w-4/5 sm:w-2/5 lg:w-1/5 my-2 mx-2">
            <img src={osakaStory} alt="" className="h-48 my-4 rounded-lg"></img>
          </div>

          <div className="w-4/5 sm:w-2/5 lg:w-1/5 my-2 mx-2">
            <img src={taipei} alt="" className="h-48 my-4 rounded-lg"></img>
          </div>

          <div className="w-4/5 sm:w-2/5 lg:w-1/5 my-2 mx-2">
            <img src={maldives} alt="" className="h-48 my-4 rounded-lg"></img>
          </div>

          <div className="w-4/5 sm:w-2/5 lg:w-1/5 my-2 mx-2">
            <img src={honeymoon} alt="" className="h-48 my-4 rounded-lg"></img>
          </div>
        </div>

        {/* <!-- Title section --> */}
        <div className="w-full flex flex-col bg-black h-auto text-white px-6 pb-6">
        ...
        <div className="w-full flex sm:flex-row flex-col flex-wrap h-auto p-4 bg-white">
          ...
          <div className="w-full sm:w-3/6 xl:w-5/6">
